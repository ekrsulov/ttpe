...
Canvas elements are the fundamental building blocks of the TTPE canvas. Every shape, path, or group on the canvas is represented by a strongly-typed element.
