...
export interface GridPluginSlice {
  ...
  grid: {
    ...
    hexOrientation?: 'pointy' | 'flat'; // For hexagonal: pointy-top or flat-top
      ...
      switch (grid.type) {
        ...
        case 'hexagonal': {
          ...
          if (orientation === 'pointy') {
            ...
            const snappedX = col * width + offsetX;
            ...
            const snappedX = col * horizontalSpacing;
            const snappedY = row * height + offsetY;
