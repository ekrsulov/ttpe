...
export const Rulers: React.FC<RulersProps> = ({ width, height, viewport }) => {
  ...
  return (
    <SharedRulers
      ...
      isDragging={guidelines?.isDraggingGuide ?? false}
      draggingType={guidelines?.draggingGuideType ?? null}
      draggingPosition={guidelines?.draggingGuidePosition ?? null}
      draggingPreviewColor={guidelines?.manualGuideColor || '#00BFFF'}
    />
  );
};
