  ...
  if (reusePath && hasExistingPencilPath) {
    ...
    state.addElement({
      ...
      data: {
        ...
        strokeLinecap: state.pencil.strokeLinecap || 'round',
        strokeLinejoin: state.pencil.strokeLinejoin || 'round',
        fillRule: state.pencil.fillRule || 'nonzero',
        strokeDasharray: state.pencil.strokeDasharray || 'none',
