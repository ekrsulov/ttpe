 ...
 * These utilities are used for common operations like formatting, element mapping,
 * and collection merging.
 */
...
/**
 * Build a Map of element IDs to elements for efficient lookups.
 * 
 * @param elements - Array of canvas elements
 * @returns Map indexed by element ID
 * 
 * @example
